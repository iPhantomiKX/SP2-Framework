...
void Camera3::Init(const Vector3& pos, const Vector3& target, const Vector3& up)
{
	...
	//Minerals hitbox
	MineralVectors.push_back(Vector3(-391, 5, -69));
	MineralVectors.push_back(Vector3(-449, 5, 94));
	MineralVectors.push_back(Vector3(-560, 5, -387));
	MineralVectors.push_back(Vector3(-627, 5, -139));
	MineralVectors.push_back(Vector3(-775, 5, -812));
	MineralVectors.push_back(Vector3(-337, 5, -260));
	MineralVectors.push_back(Vector3(-225, 5, -709));
	MineralVectors.push_back(Vector3(-530, 5, -288));
	MineralVectors.push_back(Vector3(-425, 5, 31));
	MineralVectors.push_back(Vector3(-80, 5, -766));
