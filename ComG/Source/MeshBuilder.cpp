...
//Mesh* MeshBuilder::GenerateLines(const std::string &meshName, float length)
//{
//	std::vector<Vertex> vertex_buffer_data;
//	std::vector<GLuint> index_buffer_data;
//	Vertex v;
...
Mesh* MeshBuilder::GenerateQuad2(const std::string &meshName, Color color, TexCoord texCoord)
{
	std::vector<Vertex> vertex_buffer_data;
	std::vector<GLuint> index_buffer_data;
	Vertex v;
	...
	//top
	v.pos.Set(0.5f, 0.f, 0.5f);	v.color = color;	v.texCoord.Set(texCoord.u, 0); v.normal.Set(0, 1, 0);	vertex_buffer_data.push_back(v);
	v.pos.Set(0.5f, 0.f, -0.5f);	v.color = color; v.texCoord.Set(texCoord.u, texCoord.v);	v.normal.Set(0, 1, 0);	vertex_buffer_data.push_back(v);
	v.pos.Set(-0.5f, 0.f, -0.5f);	v.color = color; v.texCoord.Set(0, texCoord.v);	v.normal.Set(0, 1, 0);	vertex_buffer_data.push_back(v);
	v.pos.Set(0.5f, 0.f, 0.5f);	v.color = color; v.texCoord.Set(texCoord.u, 0);	v.normal.Set(0, 1, 0);	vertex_buffer_data.push_back(v);
	v.pos.Set(-0.5f, 0.f, -0.5f);	v.color = color; v.texCoord.Set(0, texCoord.v);	v.normal.Set(0, 1, 0);	vertex_buffer_data.push_back(v);
	v.pos.Set(-0.5f, 0.f, 0.5f);	v.color = color; v.texCoord.Set(0, 0);	v.normal.Set(0, 1, 0);	vertex_buffer_data.push_back(v);
...
Mesh* MeshBuilder::GenerateText(const std::string &meshName, unsigned numRow, unsigned numCol)
{
	...
	//top
	//v.pos.Set(0.5f, 0.5f, 0.f);		v.texCoord.Set(0, 0);   v.normal.Set(0, 1, 0);	vertex_buffer_data.push_back(v);
	//v.pos.Set(0.5f, -0.5f, 0.f);	v.texCoord.Set(1, 0);	v.normal.Set(0, 1, 0);	vertex_buffer_data.push_back(v);
	//v.pos.Set(-0.5f, -0.5f, 0.f);	v.texCoord.Set(1, 1);	v.normal.Set(0, 1, 0);	vertex_buffer_data.push_back(v);
	//v.pos.Set(0.5f, 0.5f, 0.f);		v.texCoord.Set(0, 0);	v.normal.Set(0, 1, 0);	vertex_buffer_data.push_back(v);
	//v.pos.Set(-0.5f, -0.5f, 0.f);	v.texCoord.Set(1, 1);	v.normal.Set(0, 1, 0);	vertex_buffer_data.push_back(v);
	//v.pos.Set(-0.5f, 0.5f, 0.f);	v.texCoord.Set(0, 1);	v.normal.Set(0, 1, 0);	vertex_buffer_data.push_back(v);

	float width = 1.0f / numRow;
	float height = 1.0f / numCol;
	int offset = 0;
	for (unsigned j = 0; j < numRow; ++j)
	{
		...
		{
			//First grid
			v.pos.Set(-0.5f, -0.5f, 0.f);	v.texCoord.Set(i * width, 1.f - (j + 1) * height); vertex_buffer_data.push_back(v);
			v.pos.Set(0.5f, -0.5f, 0.f);	v.texCoord.Set((i + 1) * width, 1.f - (j + 1) * height); vertex_buffer_data.push_back(v);
			v.pos.Set(0.5f, 0.5f, 0.f);	v.texCoord.Set((i + 1) * width, 1.f - j * height); vertex_buffer_data.push_back(v);
			v.pos.Set(-0.5f, 0.5f, 0.f);	v.texCoord.Set(i * width, 1.f - j * height); vertex_buffer_data.push_back(v);
